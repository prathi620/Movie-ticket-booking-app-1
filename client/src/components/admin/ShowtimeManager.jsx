...
const ShowtimeManager = () => {
    ...
    const fetchShowtimes = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/api/theaters/showtimes/${selectedMovie}`);
            const data = await res.json();
    ...
    const handleSaveShowtime = async (e) => {
        ...
        const url = editingShowtime
            ? `${API_URL}/api/theaters/showtimes/${editingShowtime._id}`
            : `${API_URL}/api/theaters/showtimes`;
    ...
    const handleDeleteShowtime = async (id) => {
        ...
        try {
            const res = await fetch(`${API_URL}/api/theaters/showtimes/${id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${user.token}`,
                },
