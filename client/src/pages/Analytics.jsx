    ...
    const fetchAllAnalytics = async () => {
        ...
        try {
            ...
            const [
                ...
                fetch(`${API_URL}/api/analytics/booking-trends`, { headers }),
                fetch(`${API_URL}/api/analytics/popular-movies`, { headers }),
                fetch(`${API_URL}/api/analytics/theater-occupancy`, { headers }),
                fetch(`${API_URL}/api/analytics/monthly-sales`, { headers }),
                fetch(`${API_URL}/api/analytics/user-activity`, { headers }),
                fetch(`${API_URL}/api/analytics/booking-patterns`, { headers })
            ]);
